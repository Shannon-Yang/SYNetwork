//
//  YTNetworkValidationTests.swift
//  YTNetworkExample
//
...
class YTNetworkValidationTests: XCTestCase {
    ...
    func testThatValidationForRequestWithAcceptableStatusCodeResponseSucceeds() {
        ...
        let request = YTNetworkValidationRequest(requestUrlString: "status/200")
        request.validate(statusCode: 200..<300).response { resp in
            requestError = resp.error
            expectation1.fulfill()
        }
        
        let downloadRequest = YTNetworkValidationDownloadRequest(requestUrlString: "status/200")
    ...
    func testThatValidationForRequestWithUnacceptableStatusCodeResponseFails() {
        ...
        // When
        let request = YTNetworkValidationRequest(requestUrlString: urlString)
        request
        ...
        let download = YTNetworkDownloadRequest(requestUrlString: urlString)
