//
//  SYNetworkingValidationTests.swift
//  SYNetworkingExample
//
...
class SYNetworkingValidationTests: XCTestCase {
    ...
    func testThatValidationForRequestWithAcceptableStatusCodeResponseSucceeds() {
        ...
        let request = SYNetworkingValidationRequest(requestUrlString: "status/200")
        request.validate(statusCode: 200..<300).response { resp in
            requestError = resp.error
            expectation1.fulfill()
        }
        
        let downloadRequest = SYNetworkingValidationDownloadRequest(requestUrlString: "status/200")
    ...
    func testThatValidationForRequestWithUnacceptableStatusCodeResponseFails() {
        ...
        // When
        let request = SYNetworkingValidationRequest(requestUrlString: urlString)
        request
        ...
        let download = SYNetworkingDownloadRequest(requestUrlString: urlString)
